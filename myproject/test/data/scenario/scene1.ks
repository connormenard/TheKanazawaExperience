...
[cm]
[font color=orchid]
Well, let's head over to the Sports Kobo…[l][r]
[cm]
#ジア
[freeimage layer=1 page=fore]
...
[image storage="default/JiaThinking.png" layer=1 page=fore visible=true width="419"  height="744"  x="290"  y="-104" ]
[font color=orchid]
(It’s only been 20 minutes and I’m already dying! I’m an artist, not an athlete.)[l][r]
[cm]
#こうたろう
[font color=yellow]
きゅうけいしよう[l][r]
...
Hey, I think your glasses are pretty cool. [l][r]
[cm]
#けんたろう
[font color=deepskyblue]
あ、ありがとう。。[l][r]
...
#学ステイ人
[font color=yellow]
あ、まず、５分ぐらいティッシュが入っていたペットボトルをふって、わくの右に入れてと言いました。[l][r]
...
[image storage="default/JiaEmbarressed.png" layer=1 page=fore visible=true width="419"  height="744"  x="290"  y="-104" ]
[font color=orchid]
(He used my full name...)[l][r]
(That's right! I need to be formal!)[l][r]
...
You were able to exchange LINE numbers with some of the guys you played basketball with. [l]
...
“I don't really understand. I am free right now. Did you ask if you want to eat together with me?”[l][cm]
#ジア
[font color=orchid]
...
It's relatively close to your apartment, so it's not very long of a walk. [l][cm]
...
You are a minute away from the restaurant and already late. [l][cm]
...
[font size=24 bold=true]
[font color=cyan]
[link target=*jjLateDateA] 1- おそくなってごめんなさい[endlink][r]
...
There are a lot of different foods and you can’t really read anything. [l]
...
You discuss this with Kentarou as you wait for your food. [l][cm]
...
[link target=*jjChatMoreB] 2- あの、しゅみはなに？[endlink][r]
...
#けんたろう
[font color=deepskyblue]
あ。。。夢は、アメリカに行きたい。アメリカに行って、会社で働きたいんだ。[l][r]
It's always been my dream to go to America. I want to go and work for a company there. [l][cm]
#ジア
[font color=orchid]
本当？がんばってね。[l][r]
...
#けんたろう
[font color=deepskyblue]
僕の夢かなあ。。。アメリカに行って、会社で働きたいんだ。でも、難しいよね。[l][r]
My future dream? Well, I want to go to America and work for a company. It won't be easy though.[l][cm]
#ジア
[font color=orchid]
会社で働けるといいね！アメリカって自由の国だけど、アメリカ人は人によって、何をしてもいいと思っているんだ。[l][r]
